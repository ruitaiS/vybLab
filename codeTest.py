...
def generateChild(parent, training_set, training_label):
    ...
    for i in range(0, len(training_set)):
        ...
        child1.train(training_set[i], label)
        ...
        #Child 2 gets trained by the labels
        child2.train(training_set[i], training_label[i])

    print("Percentage of labels: " + str(wrong/total))
...
def testGenerateChild():
    ...
    #Generate Children
    child1, child2 = generateChild(parent, data.digits_train_imgs, data.digits_train_labels)
